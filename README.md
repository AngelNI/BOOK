...
Note：Reprinted in https://github.com/yanshengjia/ml-road

| Book Name                                                    | Author                                                       | Category                      |
| :----------------------------------------------------------- | :----------------------------------------------------------- | :----------------------------- |
| Artificial Intelligence: A Modern Approach      | Sturart  J. Russell, Peter Norvig                            | AI               |
| Data Mining: Practical Machine Learning Tools and Techniques | Ian H. Witten, Eibe Frank                        | Data Mining   |
...
| Foundations of Machine Learning | Mehryar Mohri                                                | Machine Learning            |
